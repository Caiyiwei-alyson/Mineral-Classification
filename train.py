...
def setup(args):
    ...
    if args.method == 'resnet50':
        ...
        pretraining
        '''
        # weights_dict = torch.load('。。。/swin_tiny_patch4_window7_224.pth',
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", choices=['mineral'],
                        default="mineral",
                        help="Which dataset.")
    parser.add_argument('--data_root', type=str, default=r'data_root path')
    parser.add_argument('--save_root_path', type=str,
                        default=r'save_root_path')
    parser.add_argument('--val_save_root_path', type=str,
                        default=r'val_save_root_path')
    parser.add_argument('--method', type=str, default="swin",
                        choices=["resnet50", "mobilenet", 'swin'])
    parser.add_argument("--output_dir",
                        default=r"output_dir", type=str,
